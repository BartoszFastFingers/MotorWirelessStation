 ...
 */
#define CFG_GAP_DEVICE_NAME             "MASTER_STM32"
 ...
 */
#define CFG_BLE_OPTIONS_EXT  (SHCI_C2_BLE_INIT_OPTIONS_APPEARANCE_READONLY | SHCI_C2_BLE_INIT_OPTIONS_ENHANCED_ATT_SUPPORTED)
