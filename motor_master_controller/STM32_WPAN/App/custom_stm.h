...
{
  /* Master_SERVICE */
  CUSTOM_STM_MASTER_RX,
  CUSTOM_STM_MASTER_TX11,
} Custom_STM_Char_Opcode_t;

typedef enum
{
  /* MASTER_RX */
  CUSTOM_STM_MASTER_RX_WRITE_EVT,
  /* MASTER_TX1 */
  CUSTOM_STM_MASTER_TX11_READ_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeMaster_Rx;
extern uint16_t SizeMaster_Tx11;
