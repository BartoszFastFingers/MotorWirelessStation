...
uint8_t a_AdvData[25] =
{
  ...
  13, AD_TYPE_COMPLETE_LOCAL_NAME, 'M', 'A', 'S', 'T', 'E', 'R', '_', 'S', 'T', 'M', '3', '2',  /* Complete name */
  3, AD_TYPE_APPEARANCE, 0x01, 0x80 /* GENERIC_REMOTE_CONTOL_APPEARANCE */,
  3, AD_TYPE_ADVERTISING_INTERVAL,  0x00, 0xA0 /* 100 ms */,
